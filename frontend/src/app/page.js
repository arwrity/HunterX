  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-8 font-mono relative overflow-hidden">
      ...
      <div className="relative w-[400px] mb-6">
        ...
        />
        <div className="absolute inset-0 rounded-xl border border-transparent animate-[neonGlow_2s_linear_infinite]" />
      </div>
      ...
      <div className="flex gap-4 mb-8">
        ...
        >
          <span className="relative z-10">🎬 Animate Image</span>
      ...
      {/* === СТАТУС И РЕЗУЛЬТАТ === */}
      {loading && <p className="text-gray-400 animate-pulse text-lg">⏳ Генерация... Подожди немного...</p>}
      ...
      <footer className="mt-12 text-sm text-gray-500 z-10">
        ⚙️ Powered by <span className="text-green-400">Higgsfield API</span> &nbsp;|&nbsp; Built with 💜 by <span className="text-fuchsia-500">Yernur</span>
      </footer>
